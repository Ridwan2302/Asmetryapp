...
export default function ProfilePage() {
  ...
  return (
    <Screen>
      <div className="mb-6 text-[28px] font-bold tracking-[-0.4px] text-ink">{t('profile_title')}</div>
      ...
      <div className="mb-1 text-[13px] font-semibold tracking-[0.3px] text-soft uppercase">{t('settings_title')}</div>
      ...
      <div className="mt-7 mb-2.5 text-[13px] font-semibold tracking-[0.3px] text-soft uppercase">{t('danger_zone')}</div>
      {!confirmReset ? (
