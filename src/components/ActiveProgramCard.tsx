...
export function ActiveProgramCard({ started }: { started: StartedProgram }) {
  ...
  return (
    <div className="mb-3.5 rounded-[26px] bg-card p-4 shadow-[0_2px_6px_rgba(0,0,0,0.04),0_18px_40px_rgba(0,0,0,0.09)] ring-1 ring-black/[0.03]">
      <button className="press flex w-full items-start gap-3 text-left" onClick={() => toggleExpanded(started.id)}>
        {program.img && (
          <div className="relative h-[52px] w-[52px] shrink-0 overflow-hidden rounded-[16px] bg-fill shadow-[inset_0_0_0_1px_rgba(0,0,0,0.04)]">
