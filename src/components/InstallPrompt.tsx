...
export function InstallPrompt() {
  ...
  return (
    <div className="fixed inset-x-0 top-0 z-50 flex justify-center px-3 pt-[calc(env(safe-area-inset-top)+10px)]">
      <div className="w-full max-w-[456px] animate-[slide-up_0.4s_cubic-bezier(0.34,1.56,0.64,1)] rounded-[22px] border border-border bg-card p-3 shadow-[0_4px_10px_rgba(0,0,0,0.3),0_16px_40px_rgba(0,0,0,0.4)]">
