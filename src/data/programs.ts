...
export const ASMETRY_PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    weeks: [
      ...
      { n: 4, focus: 'Reveal & lock it in', why: 'Real change here comes from four weeks of nutrition and facial training compounding together, not any single session — this week proves the habits hold on their own and captures the real, comparable result.', tasks: ['Full face circuit', 'Review sleep, training, diet', 'Progress photo, front + profile', 'Hydrate 2.5L + sleep 7.5h streak'] }
    ],
    fr: {
      ...
      weeks: [
        ...
        { n: 4, focus: 'Révéler et ancrer', why: 'Le vrai changement vient ici de quatre semaines de nutrition et d’entraînement facial qui se cumulent, pas d’une seule séance — cette semaine prouve que les habitudes tiennent seules et capture le résultat réel et comparable.', tasks: ['Circuit complet du visage', 'Bilan sommeil, entraînement, alimentation', 'Photo de progression, face + profil', 'Série hydratation 2,5 L + sommeil 7h30'] }
      ]
    }
  },
  {
