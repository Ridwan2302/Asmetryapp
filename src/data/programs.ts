...
export const ASMETRY_PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    name: 'Skinmaxing', tagline: 'Barrier · glow · homemade care', anatomy: 'Skin Cross-Section',
    ...
    fr: {
      name: 'Skinmaxing', tagline: 'Barrière cutanée · éclat · soin maison', anatomy: 'Coupe transversale de la peau',
  ...
  },
  {
    ...
    name: 'Skin Clarity Reset', tagline: 'Calm skin · natural care · even tone', anatomy: 'Skin Cross-Section',
    ...
    fr: {
      name: 'Reset Clarté de Peau', tagline: 'Peau apaisée · soin naturel · teint uni', anatomy: 'Coupe transversale de la peau',
