...
export const ASMETRY_PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    fr: {
      ...
      weeks: [
        { n: 1, focus: 'Préparer le masséter', why: 'Le masséter ne grossit qu’en réponse à une véritable résistance, donc la première semaine sert d’étalonnage — chewing-gum léger, faible volume de serrage — pour trouver une intensité de travail sans surcharger un muscle qui n’a pas l’habitude d’être entraîné.', tasks: ['Échauffement : 20 serrages lents de mâchoire', 'Chewing-gum résistant : 3 min par côté', 'Rentrées de menton : 3 séries de 12', 'Massage de relâchement du fascia mandibulaire, 2 min'] },
        { n: 2, focus: 'Ajouter de la résistance', why: 'La surcharge progressive est tout le mécanisme ici — un chewing-gum plus ferme et des maintiens isométriques plus longs forcent le masséter à s’adapter davantage, de la même façon qu’ajouter du poids force n’importe quel autre muscle à grossir.', tasks: ['Chewing-gum ferme : 5 min par côté', 'Maintiens isométriques de serrage : 3 × 20s', 'Rentrées de menton : 4 séries de 15', 'Étirement cou + mâchoire, 2 min'] },
        { n: 3, focus: 'Charge maximale', why: 'C’est volontairement la semaine la plus intense — chewing-gum dur, maintiens lestés — car l’hypertrophie a besoin d’un vrai pic de stimulation, pas seulement d’un entretien stable. Le relâchement profond qui suit évite que l’articulation de la mâchoire ne soit surmenée en même temps que le muscle.', tasks: ['Chewing-gum dur : 6 min par côté', 'Maintiens de serrage lestés : 4 × 20s', 'Tirés de lèvre inférieure : 3 séries de 15', 'Relâchement profond du masséter, 3 min'] },
        { n: 4, focus: 'Affiner et récupérer', why: 'Après trois semaines de charge croissante, le masséter a besoin d’un allègement pour vraiment révéler ses résultats — la pyramide dégressive maintient la stimulation sans ajouter de fatigue, et le travail de récupération laisse le nouveau muscle se stabiliser pour une mâchoire visiblement plus nette.', tasks: ['Circuit chewing-gum : 5 min par côté', 'Pyramide de serrage : 5 séries dégressives', 'Photo de progression, profil + 45°', 'Massage complet de récupération mâchoire + cou'] }
      ]
    }
  },
  {
  ...
  },
  {
    ...
    fr: {
      ...
      weeks: [
        { n: 1, focus: 'Réparer les fondations', why: 'La production hormonale a besoin de matières premières et d’une glycémie stable avant tout le reste — supprimer le sucre liquide et les fritures à l’huile de graines, ainsi qu’assurer soleil matinal et vrai sommeil, élimine d’abord les plus grands perturbateurs.', tasks: ['Protéines : 1,8 g par kg de poids de corps', 'Supprimer le sucre liquide + les fritures à l’huile de graines', 'Soleil 15 min avant midi', 'Fenêtre de sommeil de 8h'] },
